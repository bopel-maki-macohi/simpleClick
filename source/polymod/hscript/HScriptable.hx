...
{
	/**
	 * DON'T SET `idDynId` DIRECTLY!
	 * Just pass an identifier into `id` instead of a constant.
	 */
	public var idDynId(default, set):String = null;

	function set_idDynId(newValue:String):String
	{
		this.id = null;
		this.idDynId = newValue;
		return this.idDynId;
	}

	public var id(default, set):String = null;

	function set_id(newValue:String):String
	{
		if (idDynId != null) return null;
	...
	public static var CANCELLABLE_DEFAULT:Bool = false;
	...
	public static var RUN_BEFORE_DEFAULT:Bool = false;
	...
	public static var OPTIONAL_DEFAULT:Bool = false;
	...
	public function mergeId(newValue:String, ?newDynValue:String = null):HScriptParams
	{
		if (newDynValue != null)
		{
			idDynId = newDynValue;
		...
		{
			if (idDynId == null && newValue != null) id = newValue;
		}
		return this;
	}
	...
	public function merge(newValue:HScriptParams)
	{
		return this.mergeCancellable(newValue.cancellable)
			...
			.mergeId(newValue.id, newValue.idDynId);
	}
