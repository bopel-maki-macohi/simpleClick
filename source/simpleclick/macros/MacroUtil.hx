...
class MacroUtil
{
	...
	public static function getClassTypeFromExpr(e:Expr):ClassType
	{
		...
		while (nextSection != null)
		{
			...
			switch (section)
			{
				// Expression is a class name with no package simpleclick.s
				case EConst(c):
					switch (c)
					{
						case CIdent(cn):
				...
				// Expression is a fully qualified package simpleclick.name.
				// We need to traverse the expression tree to get the full package simpleclick.name.
